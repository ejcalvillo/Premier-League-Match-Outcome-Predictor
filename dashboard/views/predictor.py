...
Uses the trained Random Forest model from notebooks/Advanced/FINALMODELS.ipynb.
...
def load_model(model_name: str = "catboost"):
    ...
    try:
        # From dashboard/pages/predictor.py, parents[2] = ai_sports_analytics/
    ...
    if unseen_matches:
        ...
        for idx, (home_team_opt, away_team_opt) in enumerate(unseen_matches):
            ...
            with col:
                ...
                if is_selected:
                    button_label = f"Selected: {home_team_opt}\nvs\n{away_team_opt}"
            ...
            if st.button("Generate Prediction", type="primary", use_container_width=True):
                if home_team == away_team:
                    ...
                    **AI Model:** {"Random Forest (Trained on 2021-2025 Premiere League Data.)"}
                    ...
                    # Disclaimer
                    st.warning("""
                    **Note:** Predictions are based on historical data and statistical patterns. 
